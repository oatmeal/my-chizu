 ...
 *
 * Counted over **every** photo the dimension carries, not over the timeline
 * selection or the viewport, so the chips and their numbers hold still while
 * you scrub and pan. A filter whose options rearrange themselves as you use the
 * map is a filter you cannot aim.
 *
